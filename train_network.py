...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        for epoch in range(epoch_to_start, num_train_epochs):
            ...
            log.info(f"Process: {accelerator.state.local_process_index + 1 }/{accelerator.state.num_processes} Length of Dataloader: {len(skipped_dataloader or train_dataloader)}")
